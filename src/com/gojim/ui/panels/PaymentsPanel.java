...
import com.gojim.ui.components.AddPaymentDialog;
...
public class PaymentsPanel extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        RoundedTextField searchField = new RoundedTextField("Search payment...", 20);
        searchField.setPreferredSize(new Dimension(200, 42));

        RoundedButton addBtn = new RoundedButton("+ Add Payment", 18);
        RoundedButton editStatusBtn = new RoundedButton("Edit Status", 18);
        ...
        addBtn.addActionListener(e -> {
            ...
            if (dialog.isConfirmed()) {
                boolean success = paymentDAO.addPayment(
                        dialog.getSelectedMemberId(),
                        Double.parseDouble(dialog.getAmountValue()),
                        dialog.getStatusValue());

                if (success) {
                    loadPaymentsFromDatabase();
                } else {
                    JOptionPane.showMessageDialog(this, "Could not add payment.");
                }
            }
        });
        ...
        editStatusBtn.addActionListener(e -> {
            ...
            if (success) {
                ...
                JOptionPane.showMessageDialog(this, "Could not update payment status.");
            }
        });
        ...
        deleteBtn.addActionListener(e -> {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                if (success) {
                    ...
                    JOptionPane.showMessageDialog(this, "Could not delete payment.");
                }
            }
        });
    ...
    private RoundedPanel createTable() {
        ...
        String[] cols = { "ID", "Member Name", "Amount", "Date", "Status" };
